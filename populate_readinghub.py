...
def populate():
    ...
    children_books = [
        ...
        {"title": "The Lion, the Witch and the Wardrobe",
         ...
         "likes": 72,
         "image": "book10.jpg",
         "recommender": "AsuquoEffiongGlory"},
    ...
    for cat, cat_data in cats.items():
        ...
        for b in cat_data["books"]:
            add_book(c, b["title"], b["author"], b["url"], b["description"], b["likes"], b["image"], b["recommender"])
...
def add_book(cat, title, author, url, description, likes, image, recommender):
    ...
    b.likes = likes
    b.image = image
    b.recommender = User.objects.filter(username=recommender)[0]
    b.save()
    return b
